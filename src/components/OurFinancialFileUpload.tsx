...
interface OurFinancialFileUploadProps {
  onFieldsExtracted: (fields: OurFinancialData, fileInfo?: {
    file: File;
    fileName: string;
    fileType: string;
  }) => void;
...
const OurFinancialFileUpload = ({ onFieldsExtracted }: OurFinancialFileUploadProps) => {
  ...
  const handleFile = async (file: File) => {
    ...
    try {
      ...
      console.log('Processing our financial document:', file.name, file.type);
      ...
      // Map the extracted data to our structure
      const ourFinancialData: OurFinancialData = {
        payment_for: extractedData.to_entity || '',
        transaction_type: extractedData.transaction_type,
        who_paid: extractedData.from_entity || '',
        for_who: 'Both', // Default value
      ...
      console.error('Error analyzing our financial document:', error);
      toast({
          ...
          <div className="flex flex-col items-center space-y-4">
            {isUploading ? (
              ...
              <>
                ...
                <label htmlFor="our-financial-file-upload">
...
export default OurFinancialFileUpload;